...
import seederData from "./tktCollectionDetails.seeder.json";
...
const TktCollectionDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TktCollectionDetailsSeederDialogComponent);
