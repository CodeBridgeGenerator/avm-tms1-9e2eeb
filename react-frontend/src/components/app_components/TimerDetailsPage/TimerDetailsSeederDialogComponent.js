...
import seederData from "./timerDetails.seeder.json";
...
const TimerDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TimerDetailsSeederDialogComponent);
