...
import seederData from "./userChecklistDetails.seeder.json";
...
const UserChecklistDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(UserChecklistDetailsSeederDialogComponent);
